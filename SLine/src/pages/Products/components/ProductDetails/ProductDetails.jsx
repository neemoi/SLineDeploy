...
function ProductDetails() {
    ...
    const fetchProductData = async () => {
        try {
            const response = await fetch(`http://109.107.189.127/api/Catalog/Product/${productId}`);
            ...
            const priceResponse = await fetch(`http://109.107.189.127/api/Catalog/Warehouse/${productId}`);
