...
function AuthModal({ show, handleClose }) {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:7036/Authorization/forgot-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        >
          <Tab eventKey="login" title="Вход">
            <form
              ...
              onSubmit={(e) =>
                handleSubmit(e, 'http://localhost:7036/Authorization/Login', 'POST', {
          ...
          <Tab eventKey="register" title="Регистрация">
            <form
              ...
              onSubmit={(e) =>
                handleSubmit(
                  e,
                  'http://localhost:7036/Authorization/Register',
                  'POST',
                  {
