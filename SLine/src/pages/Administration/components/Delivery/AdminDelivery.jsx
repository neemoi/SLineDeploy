...
function AdminDeliveryOption() {
    ...
    const fetchDeliveryOptions = () => {
        fetch('https://sline.site/api/GetAllDeliveryOption')
    ...
    const fetchStores = () => {
        fetch('https://sline.site/api/GetAllStore')
            .then(response => response.json())
    ...
    const addDeliveryOption = () => {
        ...
        fetch('https://sline.site/api/AddDeliveryOption', {
            method: 'POST',
            headers: {
    ...
    const updateDeliveryOption = () => {
        ...
        const url = 'https://sline.site/api/UpdateDeliveryOption';
        const payload = {
    ...
    const handleDelete = (optionId) => {
        if (window.confirm('Вы уверены, что хотите удалить эту опцию доставки?')) {
            fetch(`https://sline.site/api/DeleteDeliveryOption/${optionId}`, {
                method: 'DELETE',
            })
