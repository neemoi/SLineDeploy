...
const Stores = () => {
    ...
    const fetchStoresData = async () => {
        try {
            const storesResponse = await fetch('http://http://109.107.189.127/api//api/Store/AllStores');
            const storesData = await storesResponse.json();

            const chainsResponse = await fetch('http://http://109.107.189.127/api//api/Store/Chains');
