...
function AdminWarehouses() {
    ...
    const fetchWarehouses = () => {
        fetch('http://45.142.122.22/GetAllWarehouses')
    ...
    const handleAddOrUpdateWarehouse = () => {
        ...
        const url = currentWarehouse.warehouseId === 0
            ? 'http://45.142.122.22/AddWarehouse'
            : 'http://45.142.122.22/UpdateWarehouse';
    ...
    const handleDeleteWarehouse = (warehouseId) => {
        fetch(`http://45.142.122.22/DeleteWarehouse/${warehouseId}`, {
            method: 'DELETE'
        })
        .then(response => response.json())
        .then(data => {
